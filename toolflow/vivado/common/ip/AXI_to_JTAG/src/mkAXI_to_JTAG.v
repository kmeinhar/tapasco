...
//
// On Tue Jun 30 19:38:08 CEST 2020
//
//
// Ports:
// Name                         I/O  size props
...
// s_AXI_JTAG_wdata               I    64
// s_AXI_JTAG_wstrb               I     8
...
module mkAXI_to_JTAG(ACLK,
  ...
  input  [63 : 0] s_AXI_JTAG_wdata;
  input  [7 : 0] s_AXI_JTAG_wstrb;
  ...
  // inlined wires
  wire [105 : 0] axi_to_jtag_internal_s_read_in_rv$port1__read,
  ...
  reg [63 : 0] axi_to_jtag_address;
  wire [63 : 0] axi_to_jtag_address$D_IN;
  wire axi_to_jtag_address$EN;

  // register axi_to_jtag_data
  reg [63 : 0] axi_to_jtag_data;
  wire [63 : 0] axi_to_jtag_data$D_IN;
  ...
  reg [105 : 0] axi_to_jtag_internal_s_read_in_rv;
  wire [105 : 0] axi_to_jtag_internal_s_read_in_rv$D_IN;
  ...
  reg [79 : 0] axi_to_jtag_internal_s_read_out_rv;
  wire [79 : 0] axi_to_jtag_internal_s_read_out_rv$D_IN;
  wire axi_to_jtag_internal_s_read_out_rv$EN;

  // register axi_to_jtag_internal_s_write_in_addr_rv
  reg [105 : 0] axi_to_jtag_internal_s_write_in_addr_rv;
  wire [105 : 0] axi_to_jtag_internal_s_write_in_addr_rv$D_IN;
  wire axi_to_jtag_internal_s_write_in_addr_rv$EN;

  // register axi_to_jtag_internal_s_write_in_data_rv
  reg [73 : 0] axi_to_jtag_internal_s_write_in_data_rv;
  wire [73 : 0] axi_to_jtag_internal_s_write_in_data_rv$D_IN;
  ...
  wire [63 : 0] axi_to_jtag_internal_jtag_tap_read_req_fifo$D_IN,
  ...
  wire [127 : 0] axi_to_jtag_internal_jtag_tap_write_req_fifo$D_IN,
  ...
  wire [63 : 0] axi_to_jtag_internal_jtag_tap_internal_jtag_ma_ETC__q4,
		response_data__h10130,
		x__h5396,
		x_data__h10213,
		x_data__h10928,
		y__h5446,
		y_avValue_data__h11194;
  wire [14 : 0] IF_s_AXI_JTAG_arcache_EQ_0_10_OR_s_AXI_JTAG_ar_ETC___d525,
		IF_s_AXI_JTAG_awcache_EQ_0_38_OR_s_AXI_JTAG_aw_ETC___d553;
  wire [7 : 0] x__h5423;
  ...
  assign s_AXI_JTAG_arready =
	     ...
	     !axi_to_jtag_internal_s_read_in_rv$port1__read[105] ;

  // value method s_AXI_JTAG_s_read_fab_rvalid
  assign s_AXI_JTAG_rvalid =
	     !axi_to_jtag_internal_s_read_isRst_isInReset &&
	     axi_to_jtag_internal_s_read_out_rv[79] ;

  // value method s_AXI_JTAG_s_read_fab_rid
  assign s_AXI_JTAG_rid =
	     axi_to_jtag_internal_s_read_out_rv[79] ?
	       axi_to_jtag_internal_s_read_out_rv[78:67] :
	       12'd0 ;

  // value method s_AXI_JTAG_s_read_fab_rdata
  assign s_AXI_JTAG_rdata =
	     axi_to_jtag_internal_s_read_out_rv[79] ?
	       axi_to_jtag_internal_s_read_out_rv[66:3] :
	       64'd0 ;
  ...
  assign s_AXI_JTAG_awready =
	     ...
	     !axi_to_jtag_internal_s_write_in_addr_rv$port1__read[105] ;

  // value method s_AXI_JTAG_s_write_fab_wready
  assign s_AXI_JTAG_wready =
	     !axi_to_jtag_internal_s_write_isRst_isInReset &&
	     !axi_to_jtag_internal_s_write_in_data_rv$port1__read[73] ;
  ...
  assign MUX_axi_to_jtag_internal_jtag_tap_internal_jtag_master_jtag_req$enq_1__SEL_2 =
	     WILL_FIRE_RL_axi_to_jtag_internal_jtag_tap_receive_write_request &&
	     (axi_to_jtag_internal_jtag_tap_write_req_fifo$D_OUT[71:64] ==
	      8'd0 &&
  ...
  assign MUX_axi_to_jtag_received_addr$write_1__SEL_2 =
	     axi_to_jtag_internal_s_write_in_addr_rv[105] &&
	     !axi_to_jtag_received_addr ;
  assign MUX_axi_to_jtag_received_data$write_1__SEL_2 =
	     axi_to_jtag_internal_s_write_in_data_rv[73] &&
	     !axi_to_jtag_received_data ;
  ...
  begin
    case (axi_to_jtag_internal_jtag_tap_write_req_fifo$D_OUT[71:64])
      8'd0:
	  MUX_axi_to_jtag_internal_jtag_tap_internal_jtag_master_jtag_req$enq_1__VAL_2 =
	      74'd0;
      8'd8:
  ...
  assign MUX_axi_to_jtag_internal_jtag_tap_internal_jtag_master_jtag_req$enq_1__VAL_4 =
	     { axi_to_jtag_internal_jtag_tap_access_dm ?
		 x_data__h10928 :
		 axi_to_jtag_internal_jtag_tap_write_req_fifo$D_OUT[63:0],
	       axi_to_jtag_internal_jtag_tap_register_width,
	       2'd2 } ;
  ...
  assign axi_to_jtag_internal_s_read_arinpkg$wget =
	     { s_AXI_JTAG_arid,
	       ...
	       s_AXI_JTAG_arburst,
	       s_AXI_JTAG_arlock,
	       IF_s_AXI_JTAG_arcache_EQ_0_10_OR_s_AXI_JTAG_ar_ETC___d525 } ;
  ...
  assign axi_to_jtag_internal_s_read_in_rv$EN_port0__write =
	     axi_to_jtag_internal_s_read_in_rv[105] &&
	     axi_to_jtag_internal_jtag_tap_read_req_fifo$FULL_N ;
  ...
  assign axi_to_jtag_internal_s_read_in_rv$port1__write_1 =
	     { 1'd1,
	       axi_to_jtag_internal_s_read_arinpkg$wget[104:15],
	       CASE_axi_to_jtag_internal_s_read_arinpkgwget__ETC__q6,
  ...
  assign axi_to_jtag_internal_s_read_out_rv$EN_port1__write =
	     axi_to_jtag_internal_jtag_tap_read_rsp_fifo$EMPTY_N &&
	     !axi_to_jtag_internal_s_read_out_rv$port1__read[79] ;
  ...
  assign axi_to_jtag_internal_s_write_in_addr_rv$port1__write_1 =
	     { 1'd1,
	       axi_to_jtag_internal_s_write_arinpkg_addr$wget[104:15],
	       CASE_axi_to_jtag_internal_s_write_arinpkg_addr_ETC__q7,
  ...
  assign axi_to_jtag_address$D_IN =
	     axi_to_jtag_internal_s_write_in_addr_rv[92:29] ;
  assign axi_to_jtag_address$EN =
	     MUX_axi_to_jtag_received_addr$write_1__SEL_2 ;

  // register axi_to_jtag_data
  assign axi_to_jtag_data$D_IN =
	     axi_to_jtag_internal_s_write_in_data_rv[72:9] ;
  ...
  // register axi_to_jtag_read_id
  assign axi_to_jtag_read_id$D_IN =
	     axi_to_jtag_internal_s_read_in_rv[104:93] ;
  ...
  assign axi_to_jtag_write_id$D_IN =
	     axi_to_jtag_internal_s_write_in_addr_rv[104:93] ;
  ...
  assign axi_to_jtag_internal_jtag_tap_read_req_fifo$D_IN =
	     axi_to_jtag_internal_s_read_in_rv[92:29] ;
  ...
  assign IF_axi_to_jtag_internal_jtag_tap_internal_jtag_ETC___d321 =
	     (axi_to_jtag_internal_jtag_tap_internal_jtag_master_desired_tap_state ==
	      4'd1) ?
	       axi_to_jtag_internal_jtag_tap_internal_jtag_master_desired_tap_state :
	       4'd2 ;
  assign IF_s_AXI_JTAG_arcache_EQ_0_10_OR_s_AXI_JTAG_ar_ETC___d525 =
	     { CASE_s_AXI_JTAG_arcache_0_s_AXI_JTAG_arcache_1_ETC__q1,
	       s_AXI_JTAG_arprot,
	       s_AXI_JTAG_arqos,
	       s_AXI_JTAG_arregion } ;
  assign IF_s_AXI_JTAG_awcache_EQ_0_38_OR_s_AXI_JTAG_aw_ETC___d553 =
	     { CASE_s_AXI_JTAG_awcache_0_s_AXI_JTAG_awcache_1_ETC__q2,
	       s_AXI_JTAG_awprot,
	       s_AXI_JTAG_awqos,
	       s_AXI_JTAG_awregion } ;
  ...
  begin
    if (ARESETN == `BSV_RESET_VALUE)
      begin
        axi_to_jtag_address <= `BSV_ASSIGNMENT_DELAY 64'd0;
	axi_to_jtag_data <= `BSV_ASSIGNMENT_DELAY 64'd0;
  ...
  initial
  begin
    axi_to_jtag_address = 64'hAAAAAAAAAAAAAAAA;
    axi_to_jtag_data = 64'hAAAAAAAAAAAAAAAA;
    ...
    axi_to_jtag_internal_s_read_in_rv = 106'h2AAAAAAAAAAAAAAAAAAAAAAAAAA;
    axi_to_jtag_internal_s_read_isRst_isInReset = 1'h0;
    axi_to_jtag_internal_s_read_out_rv = 80'hAAAAAAAAAAAAAAAAAAAA;
    axi_to_jtag_internal_s_write_in_addr_rv =
	106'h2AAAAAAAAAAAAAAAAAAAAAAAAAA;
    axi_to_jtag_internal_s_write_in_data_rv = 74'h2AAAAAAAAAAAAAAAAAA;
