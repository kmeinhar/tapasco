...
//
// On Wed Sep 16 11:40:04 CEST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXI_to_Dmi(ACLK,
  ...
  // register axi_to_dmi_write_counter
  always@(axi_to_dmi_write_counter or x__h5729)
  begin
    case (axi_to_dmi_write_counter)
      5'd0: axi_to_dmi_write_counter$D_IN = x__h5729;
      5'd3: axi_to_dmi_write_counter$D_IN = 5'd0;
      default: axi_to_dmi_write_counter$D_IN = x__h5729;
    endcase
  end
  ...
  assign IF_s_AXI_Dmi_awcache_EQ_0_10_OR_s_AXI_Dmi_awca_ETC___d225 =
	     { CASE_s_AXI_Dmi_awcache_0_s_AXI_Dmi_awcache_1_s_ETC__q2,
	       ...
	       s_AXI_Dmi_awqos,
	       s_AXI_Dmi_awregion } ;
  assign x__h5729 = axi_to_dmi_write_counter + 5'd1 ;
  assign x_dmi_data__h5504 = axi_to_dmi_data_pcie | axi_to_dmi_data ;
