...
module mkJTAG_switch(ACLK,
  ...
  // action method jtag_slave_n_rst_action
  input  jtag_slave_N_RST;
  ...
  // value method jtag_master_0_trst
  output jtag_master_0_TRST;
  ...
  // value method jtag_master_1_trst
  output jtag_master_1_TRST;
  ...
  // value method jtag_master_2_trst
  output jtag_master_2_TRST;
  ...
  // value method jtag_master_3_trst
  output jtag_master_3_TRST;
  ...
  // value method jtag_master_0_trst
  assign jtag_master_0_TRST =
	     internal_slave_select != 2'd0 || internal_n_rst ;
  ...
  // value method jtag_master_1_trst
  assign jtag_master_1_TRST =
	     internal_slave_select != 2'd1 || internal_n_rst ;
  ...
  // value method jtag_master_2_trst
  assign jtag_master_2_TRST =
	     jtag_master == 2'd3 &&
	     (internal_slave_select != 2'd2 || internal_n_rst) ;
  ...
  // value method jtag_master_3_trst
  assign jtag_master_3_TRST = 1'd0 ;
  ...
  // register internal_n_rst
  assign internal_n_rst$D_IN = jtag_slave_N_RST ;
