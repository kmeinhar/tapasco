...
//
// On Fri Jul 17 15:28:50 CEST 2020
//
//
// Ports:
// Name                         I/O  size props
...
// jtag_master_3_TCK              O     1
// jtag_master_3_TMS              O     1
// jtag_master_3_TDI              O     1
// ACLK                           I     1 clock
// ARESETN                        I     1 reset
// slave_select                   I     3 reg
// jtag_slave_TCK                 I     1
// jtag_slave_TMS                 I     1
// jtag_slave_TDI                 I     1
...
//    jtag_master_1_TDO,
//    jtag_master_2_TDO,
//    jtag_master_3_TDO) -> jtag_slave_TDO
//
//
...
module mkJTAG_switch(ACLK,
		     ...
		     jtag_master_3_TDO);
  parameter [2 : 0] jtag_master = 3'b0;
  input  ACLK;
  input  ARESETN;
  ...
  reg [2 : 0] internal_slave_select;
  wire [2 : 0] internal_slave_select$D_IN;
  ...
  wire NOT_jtag_master_ULE_2___d8, NOT_jtag_master_ULE_3_1___d12;

  // value method jtag_slave_tdo
  always@(internal_slave_select or
	  NOT_jtag_master_ULE_3_1___d12 or
	  jtag_master_3_TDO or
	  jtag_master_0_TDO or
	  jtag_master_1_TDO or
	  NOT_jtag_master_ULE_2___d8 or jtag_master_2_TDO)
  begin
    case (internal_slave_select)
      3'd0: jtag_slave_TDO = jtag_master_0_TDO;
      3'd1: jtag_slave_TDO = jtag_master_1_TDO;
      3'd2: jtag_slave_TDO = NOT_jtag_master_ULE_2___d8 && jtag_master_2_TDO;
      default: jtag_slave_TDO =
		   NOT_jtag_master_ULE_3_1___d12 && jtag_master_3_TDO;
    endcase
  end

  // value method jtag_master_0_tck
  assign jtag_master_0_TCK = internal_slave_select != 3'd0 || internal_tck ;

  // value method jtag_master_0_tms
  assign jtag_master_0_TMS = internal_slave_select != 3'd0 || internal_tms ;

  // value method jtag_master_0_tdi
  assign jtag_master_0_TDI = internal_slave_select == 3'd0 && internal_tdi ;

  // value method jtag_master_1_tck
  assign jtag_master_1_TCK = internal_slave_select != 3'd1 || internal_tck ;

  // value method jtag_master_1_tms
  assign jtag_master_1_TMS = internal_slave_select != 3'd1 || internal_tms ;

  // value method jtag_master_1_tdi
  assign jtag_master_1_TDI = internal_slave_select == 3'd1 && internal_tdi ;

  // value method jtag_master_2_tck
  assign jtag_master_2_TCK =
	     NOT_jtag_master_ULE_2___d8 &&
	     (internal_slave_select != 3'd2 || internal_tck) ;

  // value method jtag_master_2_tms
  assign jtag_master_2_TMS =
	     NOT_jtag_master_ULE_2___d8 &&
	     (internal_slave_select != 3'd2 || internal_tms) ;

  // value method jtag_master_2_tdi
  assign jtag_master_2_TDI =
	     NOT_jtag_master_ULE_2___d8 && internal_slave_select == 3'd2 &&
	     internal_tdi ;

  // value method jtag_master_3_tck
  assign jtag_master_3_TCK =
	     NOT_jtag_master_ULE_3_1___d12 &&
	     (internal_slave_select != 3'd3 || internal_tck) ;

  // value method jtag_master_3_tms
  assign jtag_master_3_TMS =
	     NOT_jtag_master_ULE_3_1___d12 &&
	     (internal_slave_select != 3'd3 || internal_tms) ;

  // value method jtag_master_3_tdi
  assign jtag_master_3_TDI =
	     NOT_jtag_master_ULE_3_1___d12 && internal_slave_select == 3'd3 &&
	     internal_tdi ;
  ...
  // remaining internal signals
  assign NOT_jtag_master_ULE_2___d8 = jtag_master > 3'd2 ;
  assign NOT_jtag_master_ULE_3_1___d12 = jtag_master > 3'd3 ;
  ...
  begin
	...
	internal_slave_select <= `BSV_ASSIGNMENT_DELAY 3'd0;
